...
describe Cat do
  ...
  it "should build catalog from dir1" do
    cat1 = Cat.build_cat( File.join(@data_dir, "dir1") )
    cat1.size.should == 2
    cat1.bytes.size.should == 8
  end

  it "should load catalog from dir2" do
    cat2 = Cat.build_cat( File.join(@data_dir, "dir2") )
    cat2.size.should == 3
    cat2.bytes.should == 6
  end
  ...
  it "saving to a file" do
    ...
    dircat1_bis = Cat.new.from_file( tmp_file )
  ...
  it "should detect duplicates" do
    cat1  = Cat.build_cat( File.join(@data_dir, "dir3") )
